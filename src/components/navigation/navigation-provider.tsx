    ...
    <NavigationContext.Provider value={value}>
      ...
      >
        <div className="absolute inset-x-0 top-0 h-1 overflow-hidden bg-transparent">
          <div
            className={cn(
              "h-full w-full origin-left bg-[linear-gradient(90deg,#7CC7EE_0%,#173B42_52%,#7CC7EE_100%)] transition-transform duration-500 ease-out",
        ...
        <div className="absolute inset-0 overflow-hidden">
          <div
            className={cn(
              "absolute inset-y-0 -left-[42%] w-[55%] bg-[linear-gradient(120deg,rgba(124,199,238,0)_0%,rgba(124,199,238,0.14)_32%,rgba(23,59,66,0.16)_65%,rgba(23,59,66,0)_100%)] blur-3xl transition-transform duration-500 ease-out",
